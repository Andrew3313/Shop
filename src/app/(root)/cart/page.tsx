...
export default function Cart() {
  ...
  const handleOrder = () => {
    ...
    toast(
      "Спасибо за заказ! Вы будете перенаправлены в telegram чат для дальнейшего оформления. Если этого не произошло, попробуйте открыть страницу в другом браузере или свяжитесь с продавцом лично.",
    );
